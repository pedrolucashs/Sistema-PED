...
import controller.ExcluirProfessorController;

public class ExcluirProfessorView implements Observer {
    private Model model;
    private ExcluirProfessorController controller;
    ...
    public void init(Model model) {
        if (model != null) {
            ...
            this.controller = new ExcluirProfessorController();
